...
RENDEZVOUS_ADDR="/dnsaddr/rendezvous.coblox.tech/p2p/12D3KooWQUt9DkNZxEn2R5ymJzWj15MpG6mTW84kyd8vDaRZi46o"

# Since we always print json on stdout for `list-sellers` we don't need the `--json` flag
CLI_LIST_SELLERS="$CLI_PATH --testnet --json --debug list-sellers --rendezvous-node-addr $RENDEZVOUS_ADDR"
